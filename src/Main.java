...
//    public String permutation(int[] rule, String input ){ //ham hoan vi
//        String output = "";
//        input = hextoBin(input);
//        for (int i=0; i<rule.length;i++){
//            output = output + input.charAt(rule[i]);
//        }
//        output = binToHex(output);
//        return output;
//    }
...
//        return input;
//    }
//    public String xor(String a, String b){ //xor binary
//        String output = "";
...
//        key = permutation(PC1,key);
//        for (int i=0; i<16; i++){
//            key = shiftLeft(key.substring(0,28),shiftLeftBits[i]) + shiftLeft(key.substring(28,56),shiftLeftBits[i]);
//            keys[i] = permutation(PC2,key);
//            keys[i] = binTohex(keys[i]);
//        }
//        return keys;
//    }
//
...
//        }
////        output = hexTobin(output);
//        return output;
//    }
//    public String round(String input, String key, int number){
//        String output = "";
//        String left = input.substring(0,32);
//        String right = input.substring(32,64);
////        right = hexTobin(right);
////        left = hexTobin(left);
//        String temp = right;
...
//        plainText = permutation(initialPerm,plainText);
//
//        System.out.println(
//                "After initial permutation: "
//                        + plainText.toUpperCase());
...
//                + plainText.substring(0, 8);
//        plainText = hexTobin(plainText);
//        plainText = permutation(inverseInitialPerm, plainText);
